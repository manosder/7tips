...
<section id="redesign-main" class="body-content" role="main">
    <div class="ui-container hero-module">
        <div class="redesign-search-page container col-xs-12 col-sm-12 bg-color-gray-lightest">
            ...
            <form class="search-hero-form col-lg-8 col-md-8 col-xs-12 col-sm-12" aria-label="search-form" role="search">
                ...
                <div class="twitter-typeahead" style="position: relative; display: initial; direction: ltr;"><input
                        ...
                        type="text" data-view-all-results-toggle="False" data-view-all-results="View all results"
                        maxlength="200" aria-describedby="instructions" autocomplete="off" aria-autocomplete="both"
                        ...
                        type="text" placeholder="Type to search..." data-view-all-results-toggle="False"
                        data-view-all-results="View all results" maxlength="200" aria-describedby="instructions"
                        autocomplete="off" aria-autocomplete="both" spellcheck="false" dir="auto"
                        style="position: relative; vertical-align: top; background-color: white;" tabindex="-1">
                ...
                <button class="btn btn-primary col-xs-2" data-analytics-content-type="search activity"
                    data-analytics-link-name="search" tabindex="-1">
                    ...
                    <div class="search-results-block" aria-live="polite"
                        ...
                        <div class="search-results-area search-results-area-space">
                            <div class="results-for-keyword-container col-md-8 col-lg-8" hidden=""
                                ...
                                style="display: block;">
                                <h2 class="results-for-keyword subsection-title">Results for "ESPA ME DRASI"</h2>
                            ...
                            <div class="redesign-search-filters-container col-lg-4 col-md-4" aria-live="off">
                                ...
                                <h3 class="reinvent-filter-by eyebrow-title hidden-xs hidden-sm"
                                    data-attribute-filter-by="Filter By:">Filter By:</h3>
                                <button
                                        ...
                                        <div class="search-filter-panel form-horizontal" aria-live="off">
                                            <div class="redesign-search-filters corporate-regular"
                                                ...
                                                <div class="reinvent-checkbox INDUSTRY" tabindex="-1"
                                                    style="display: block; max-height: 342.625px; overflow-y: scroll;"
                                                    id="myDIV">
                                                    <fieldset>
                                                        <ul>
                                                            <li>
                            ...
                            <div class="recommended-content-container col-xs-12 col-sm-8 col-md-4 col-lg-4"
                                aria-live="off" hidden="" data-attribute-recommended-content="Recommended Content"
                                style="display: none;">
                                <h3 class="recommended-content eyebrow-title">Recommended Content</h3>
                            </div>
                                    ...
                                    <div class="col-sm-12 search-results-0">
                                        ...
                                        <div class="search-results-header col-sm-8 col-md-12">
                                            <h4 class="header title quarternary-title"><a
                                                    href="/gr-en/about/company/client-stories-index"
                                                    class="search-result-link cta"
                                                    data-analytics-link-name="client case studies | accenture"
                                                    data-analytics-content-type="serp-ranked">Niko se gamaw |
                                                    7tips</a></h4>
                                            <p class="content-description fluid dot-ellipsis"
                                                style="overflow-wrap: break-word;">Lore highlights their
                                                <strong>client</strong> <strong>case</strong> studies, showing how we
                                                help clients overcome their business challenges, across all industries.
                                                Learn more.
                                            </p>
                                        </div>
                                        <div class="search-results-content col-sm-8 col-md-12">
                                            <p class="category dotdot content-title fluid">INDEX</p>
                                            <p class="search-results-divider fluid"></p>
                                            <p class="date fluid"></p>
                                        </div>
                                    </div>
